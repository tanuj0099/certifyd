            ...
            >
              ...
              <div className="flex items-start justify-between pb-4 border-b border-white/10 gap-4 shrink-0">
                <div>
                  ...
                  <h2 className="text-xl font-bold text-white leading-snug">{activeNote.title}</h2>
              ...
              <div className="py-4 space-y-6 overflow-y-auto flex-1 pr-1">
                {/* Note Document Body */}
                <div className="bg-[#161B22] p-5 rounded-2xl border border-white/5 text-sm text-white/95 leading-relaxed font-sans whitespace-pre-wrap">
                  {activeNote.content}
                </div>
