...
export default function OutcomeVerificationModal({ isOpen, onClose, certName = 'AWS Solutions Architect', defaultHike = 25, predictionId = null }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-md bg-[#0F1218] border border-white/10 rounded-2xl p-6 shadow-2xl text-white font-sans">
        <button
          onClick={onClose}
        ...
        {submitted ? (
          <div className="text-center py-8 space-y-3">
            ...
            <p className="text-xs text-gray-400 max-w-xs mx-auto">
              Thank you! Your verified outcome improves prediction accuracy for future engineers across India.
            </p>
          </div>
        ) : (
