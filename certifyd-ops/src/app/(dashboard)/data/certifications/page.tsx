...
export default async function CertificationsPage() {
    ...
    if (rawLive && rawLive.length > 0) {
      rawLive.forEach((c, index) => {
        ...
        liveList.push({
          ...
          cost_usd: c.cost_usd,
          cost_inr: c.cost_inr,
          retake_cost_usd: c.retake_cost_usd,
  ...
  return (
    <ConfidentialDataShield userEmail={userEmail} userRole={userRole} sectionName="Master Certifications Catalog">
      <CertificationsClient initialLive={JSON.parse(JSON.stringify(liveList))} initialStaging={JSON.parse(JSON.stringify(stagingList))} userRole={userRole} />
