        ...
        <div className="flex items-center gap-2.5 overflow-hidden">
          ...
          >
            <img 
              ...
              style={{ filter: isEmployee 
                ? 'brightness(0) saturate(100%) invert(56%) sepia(97%) saturate(2256%) hue-rotate(124deg) brightness(98%) contrast(101%)' // #00D4A8
                : 'brightness(0) saturate(100%) invert(43%) sepia(97%) saturate(2758%) hue-rotate(338deg) brightness(101%) contrast(96%)'  // #F97316
              }} 
            />
          </div>
          {!collapsed && (
