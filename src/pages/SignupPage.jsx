      ...
      >
        ...
        >
          ...
          >
            ...
            <Link to="/terms" style={{ color: 'rgba(247,248,248,0.6)', textDecoration: 'underline' }}>Terms</Link>
            {' '}and{' '}
            <Link to="/privacy" style={{ color: 'rgba(247,248,248,0.6)', textDecoration: 'underline' }}>Privacy Policy</Link>.
          </p>
