          ...
          <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'var(--overlay-scrim, rgba(0,0,0,0.6))', display: 'grid', placeItems: 'center', padding: '20px' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '12px', flexDirection: 'column' }}>
                <button onClick={() => router.push(`/login?next=${encodeURIComponent(window.location.pathname + window.location.search)}`)} style={{ width: '100%', padding: '12px', background: 'var(--brand-primary)', color: '#fff', borderRadius: '8px', border: 'none', textAlign: 'center', fontWeight: 'bold', fontSize: '14px', cursor: 'pointer' }}>Sign In</button>
                <button onClick={() => router.push(`/signup?next=${encodeURIComponent(window.location.pathname + window.location.search)}`)} style={{ width: '100%', padding: '12px', background: 'transparent', border: '1px solid var(--border-strong)', color: 'var(--text-primary)', borderRadius: '8px', textAlign: 'center', fontWeight: 'bold', fontSize: '14px', cursor: 'pointer' }}>Create Account</button>
