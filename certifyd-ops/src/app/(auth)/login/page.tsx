      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          <div className="w-9 h-9 rounded-lg bg-[#F97316]/10 border border-[#F97316]/20 flex items-center justify-center">
            <img src="/logo.svg" alt="Certifyd" className="w-5 h-5 object-contain" style={{ filter: 'brightness(0) saturate(100%) invert(43%) sepia(97%) saturate(2758%) hue-rotate(338deg) brightness(101%) contrast(96%)' }} />
          </div>
