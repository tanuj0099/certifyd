  ...
  return (
    <>
      <SEOHead
        ...
        description="Terms of Service for Certifyd ROI Calculator."
        path="/terms"
      />
      <MarketingPageShell
      ...
      >
        <div style={{ maxWidth: '800px', margin: '0 auto', fontFamily: FB, color: 'var(--text-3)', lineHeight: 1.8 }}>
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '16px' }}>By accessing and using Certifyd ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you must not use our services.</p>
          </section>

          <section style={{ marginBottom: '40px' }}>
            <h2 style={{ fontFamily: FH, color: 'var(--text)', fontSize: '24px', marginBottom: '16px' }}>2. Use of Services</h2>
            <p style={{ marginBottom: '16px' }}>Certifyd provides career tools, certification ROI calculations, and market demand insights based on publicly available data and user-reported metrics. The information provided is for educational and informational purposes only and does not constitute guaranteed career outcomes or financial advice.</p>
          </section>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '16px' }}>All content, features, and functionality of the Platform, including but not limited to design, text, graphics, algorithms, and models, are owned by Certifyd and are protected by international copyright, trademark, and other intellectual property laws.</p>
          </section>
        </div>
      </MarketingPageShell>
    </>
