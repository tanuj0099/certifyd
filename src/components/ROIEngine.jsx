        ...
        <div className="flex flex-col justify-center gap-8 bg-white/[0.02] border border-white/5 p-8 lg:p-12 rounded-3xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col gap-10">
            ...
            <div className="grid grid-cols-2 gap-8">
              {/* Payback Period */}
              <div>
                <p className="text-sm font-medium text-zinc-400 mb-2 uppercase tracking-widest text-xs">Payback Period</p>
              ...
              {/* Net Gain */}
              <div>
                <p className="text-sm font-medium text-zinc-400 mb-2 uppercase tracking-widest text-xs">Annual Net Gain</p>
                <div className="text-4xl font-bold text-white tracking-tight">
                  {formatINR(netGain)}
                </div>
              </div>
            ...
            <div className="pt-8 border-t border-white/10">
              <p className="text-sm font-medium text-zinc-400 mb-2 uppercase tracking-widest text-xs">Total True Cost (Exam + Time)</p>
